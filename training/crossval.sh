...
# Compare split models against the reference v1 alphabet.
#
# Usage: RUN=<prefix> ./crossval.sh
# Reads:  ../data/scop_lookup.tsv, ../data/v1/
...
# Benchmark each split model against the reference v1 alphabet
for k in {0..3}; do
